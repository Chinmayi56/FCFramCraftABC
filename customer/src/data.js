...
// Customer-site pages/modules that header search should also be able to
// find (in addition to products). `keywords` lets a search term like
// "track my order" or "profile" match a page even when it doesn't contain
// the exact page name. `auth` marks pages that require a logged-in
// customer — search still surfaces them (so the customer can find "My
// Orders"), the page itself already redirects to Login when needed.
export const SITE_PAGES = [
  { name: "Home", href: "#/", icon: "home", keywords: ["home", "start"] },
  { name: "Products", href: "#/shop", icon: "package", keywords: ["shop", "products", "catalog", "machinery"] },
  { name: "About Us", href: "#/about", icon: "info", keywords: ["about", "company"] },
  { name: "Services", href: "#/services", icon: "wrench", keywords: ["services", "support", "installation"] },
  { name: "Contact", href: "#/contact", icon: "phone", keywords: ["contact", "reach", "phone", "email", "enquiry", "enquire"] },
  { name: "Wishlist", href: "#/wishlist", icon: "heart", keywords: ["wishlist", "saved", "favorites", "favourites"], auth: true },
  { name: "Cart", href: "#/cart", icon: "shopping-cart", keywords: ["cart", "basket", "checkout"], auth: true },
  { name: "My Profile", href: "#/profile", icon: "user", keywords: ["profile", "account", "my details", "address"], auth: true },
  { name: "My Orders", href: "#/orders", icon: "receipt", keywords: ["orders", "my orders", "track order", "order history"], auth: true },
];
